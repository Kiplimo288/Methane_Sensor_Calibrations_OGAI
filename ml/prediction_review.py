...
plt.scatter(data['TGS2600Corr'], data['CH4 (ppm)'], color='blue', edgecolor='blue', facecolors='none', label='Data Points')
...
plt.text(0.95, 0.78, f"$y = {m1:.4f}x + {b1:.4f}$", transform=plt.gca().transAxes, 
         fontsize=12, verticalalignment='top', horizontalalignment='right')
...
plt.figure(figsize=(8, 6))
plt.scatter(data['TGS2611Corr'], data['CH4 (ppm)'], color='blue', edgecolor='blue', facecolors='none', label='Data Points')
...
plt.text(0.95, 0.85, f"$R^2 = {r2_2:.4f}$", transform=plt.gca().transAxes, 
         fontsize=12, verticalalignment='top', horizontalalignment='right')
plt.text(0.95, 0.78, f"$y = {m2:.4f}x + {b2:.4f}$", transform=plt.gca().transAxes, 
         fontsize=12, verticalalignment='top', horizontalalignment='right')
